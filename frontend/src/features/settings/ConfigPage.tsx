    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-8 p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">
          ...
          credentials (email/password) are always read from the environment and can't be changed
          here.
        </p>
      </div>

      <form onSubmit={handleSubmit} className="flex flex-col gap-8">
        <Section title="WhatsApp webhook">
          <TextField
        ...
        <Section title="SMTP (notification email)">
          <TextField
            label="SMTP host"
        ...
        <Section title="Broadcast worker tuning">
          <div className="grid grid-cols-2 gap-4">
            <TextField
