...
const inputBase =
  'w-full px-3 py-2 rounded-xl bg-panel border border-edge-strong text-ink text-sm placeholder:text-ink-faint outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30'
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          {headerType === 'TEXT' ? (
            ...
            <div className="flex flex-col justify-end gap-1.5">
              {headerMediaId ? (
                <div className="flex items-center gap-2 rounded-xl bg-panel border border-edge-strong px-3 py-2">
                  <Image size={15} className="shrink-0 text-emerald-400" />
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-sm text-ink">{headerMediaName}</span>
                ...
                <>
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-xl bg-panel border border-dashed border-edge-strong px-3 py-2 text-sm text-ink-muted transition hover:border-emerald-500 hover:text-emerald-400 disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/60"
                  >
                    <Paperclip size={15} />
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-sm font-medium text-ink-muted">Body</span>
          <textarea
            value={body}
        ...
        {variableCount > 0 ? (
          <div className="flex flex-col gap-2 rounded-xl border border-edge bg-panel p-3">
            <span className="text-sm font-medium text-ink-muted">Sample variable values</span>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-ink-muted">Buttons</span>
          ...
          {buttons.map((b, i) => (
            <div key={i} className="flex items-start gap-2 rounded-xl border border-edge bg-panel p-3">
        ...
        <div>
          <span className="text-sm font-medium text-ink-muted">Preview</span>
          <div className="mt-2">
            <TemplatePreview
